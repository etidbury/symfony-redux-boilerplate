Symfony + React + Redux Boilerplate
===================================
...
Requirements: you need a recent version of node, like `v5.5.0`, and Webpack installed (you can install it with `npm install -g webpack webpack-dev-server`.
    ...
    git clone https://github.com/etidbury/symfony-redux-boilerplate.git
    cd symfony-redux-boilerplate
    composer install
    npm install
...
And, in `parameters.yml` add an `assets_base_url` entry:
